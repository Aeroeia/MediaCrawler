...
import { useDark, useMediaQuery, useWindowSize, onKeyStroke, useWindowScroll, useScrollLock } from "@vueuse/core";
...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"MediaCrawler自媒体爬虫","description":"小红书爬虫，抖音爬虫， 快手爬虫， B站爬虫， 微博爬虫，百度贴吧爬虫，知乎爬虫...。  ","base":"/MediaCrawler/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"editLink":{"pattern":"https://github.com/NanmiCoder/MediaCrawler/tree/main/docs/:path"},"search":{"provider":"local"},"nav":[{"text":"首页","link":"/"},{"text":"联系我","link":"/作者介绍"},{"text":"支持我","link":"/知识付费介绍"}],"sidebar":[{"text":"作者介绍","link":"/作者介绍"},{"text":"MediaCrawler使用文档","items":[{"text":"基本使用","link":"/"},{"text":"项目架构文档","link":"/项目架构文档"},{"text":"零基础源码导读","link":"/零基础源码导读"},{"text":"常见问题汇总","link":"/常见问题"},{"text":"IP代理使用","link":"/代理使用"},{"text":"词云图使用","link":"/词云图使用配置"},{"text":"项目目录结构","link":"/项目代码结构"},{"text":"手机号登录说明","link":"/手机号登录说明"}]},{"text":"知识付费","items":[{"text":"知识付费介绍","link":"/知识付费介绍"},{"text":"MediaCrawlerPro订阅","link":"/mediacrawlerpro订阅"},{"text":"MediaCrawler源码剖析课","link":"https://relakkes.feishu.cn/wiki/JUgBwdhIeiSbAwkFCLkciHdAnhh"},{"text":"开发者咨询服务","link":"/开发者咨询"}]},{"text":"MediaCrawler项目交流群","link":"/微信交流群"},{"text":"爬虫入门教程分享","items":[{"text":"我写的爬虫入门教程","link":"https://github.com/NanmiCoder/CrawlerTutorial"}]},{"text":"MediaCrawler捐赠名单","items":[{"text":"捐赠名单","link":"/捐赠名单"}]}],"socialLinks":[{"icon":"github","link":"https://github.com/NanmiCoder/MediaCrawler"}]},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
const __vite_import_meta_env__ = { "BASE_URL": "/MediaCrawler/", "DEV": false, "MODE": "production", "PROD": true, "SSR": true };
...
const VPButton = /* @__PURE__ */ _export_sfc(_sfc_main$X, [["__scopeId", "data-v-cad61b99"]]);
...
const VPHero = /* @__PURE__ */ _export_sfc(_sfc_main$V, [["__scopeId", "data-v-303bb580"]]);
...
const VPHome = /* @__PURE__ */ _export_sfc(_sfc_main$P, [["__scopeId", "data-v-686f80a6"]]);
const _sfc_main$O = {};
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        ref_key: "main",
        ref: main
      }, _attrs))} data-v-17a5e62e>`);
      if (_ctx.headers.length > 0) {
        _push(`<button class="${ssrRenderClass({ open: open.value })}" data-v-17a5e62e><span class="menu-text" data-v-17a5e62e>${ssrInterpolate(unref(resolveTitle)(unref(theme2)))}</span><span class="vpi-chevron-right icon" data-v-17a5e62e></span></button>`);
      } else {
        _push(`<button data-v-17a5e62e>${ssrInterpolate(unref(theme2).returnToTopLabel || "Return to top")}</button>`);
      }
      if (open.value) {
        _push(`<div class="items" data-v-17a5e62e><div class="header" data-v-17a5e62e><a class="top-link" href="#" data-v-17a5e62e>${ssrInterpolate(unref(theme2).returnToTopLabel || "Return to top")}</a></div><div class="outline" data-v-17a5e62e>`);
...
const VPLocalNavOutlineDropdown = /* @__PURE__ */ _export_sfc(_sfc_main$L, [["__scopeId", "data-v-17a5e62e"]]);
...
const VPFlyout = /* @__PURE__ */ _export_sfc(_sfc_main$D, [["__scopeId", "data-v-b6c34ac9"]]);
...
const VPSocialLink = /* @__PURE__ */ _export_sfc(_sfc_main$C, [["__scopeId", "data-v-eee4e7cb"]]);
...
const VPNavBarMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$y, [["__scopeId", "data-v-9c663999"]]);
const _sfc_main$x = /* @__PURE__ */ defineComponent({
...
const _sfc_main$u = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.BBQBxVAM.js"));
...
const VPNavBarTitle = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["__scopeId", "data-v-ab179fa1"]]);
const _sfc_main$r = /* @__PURE__ */ defineComponent({
...
const VPNavScreenMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["__scopeId", "data-v-7f31e1f6"]]);
const _sfc_main$n = /* @__PURE__ */ defineComponent({
...
const VPNavScreenMenuGroupLink = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["__scopeId", "data-v-19976ae1"]]);
const _sfc_main$m = /* @__PURE__ */ defineComponent({
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(sectionTag.value), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (_ctx.item.text) {
              _push2(`<div class="item"${ssrRenderAttr("role", itemRole.value)}${ssrRenderAttr("tabindex", _ctx.item.items && 0)} data-v-b7550ba0${_scopeId}><div class="indicator" data-v-b7550ba0${_scopeId}></div>`);
              if (_ctx.item.link) {
              ...
              if (_ctx.item.collapsed != null && _ctx.item.items && _ctx.item.items.length) {
                _push2(`<div class="caret" role="button" aria-label="toggle section" tabindex="0" data-v-b7550ba0${_scopeId}><span class="vpi-chevron-right caret-icon" data-v-b7550ba0${_scopeId}></span></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            if (_ctx.item.items && _ctx.item.items.length) {
              _push2(`<div class="items" data-v-b7550ba0${_scopeId}>`);
              if (_ctx.depth < 5) {
                _push2(`<!--[-->`);
...
const VPSidebarItem = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-b7550ba0"]]);
const _sfc_main$e = /* @__PURE__ */ defineComponent({
...
const VPSkipLink = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-0f60ec36"]]);
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  __name: "Layout",
  __ssrInlineRender: true,
  setup(__props) {
...
const VPTeamMembersItem = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-f3fa364a"]]);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      ...
      intervalId = setInterval(nextAd, 3e3);
    });
    onUnmounted(() => {
      if (intervalId) clearInterval(intervalId);
    });
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "vp-ad-carousel" }, _attrs))} data-v-d09bb352>`);
      if (ads.value.length > 0) {
        _push(`<div class="ad-content" data-v-d09bb352><a${ssrRenderAttr("href", ads.value[currentAdIndex.value].landingUrl)} target="_blank" rel="noopener noreferrer" data-v-d09bb352><img${ssrRenderAttr("src", ads.value[currentAdIndex.value].imageUrl)}${ssrRenderAttr("alt", ads.value[currentAdIndex.value].text)} class="ad-image" data-v-d09bb352><p class="ad-text" data-v-d09bb352>${ssrInterpolate(ads.value[currentAdIndex.value].text)}</p></a></div>`);
      } else {
        _push(`<p class="loading" data-v-d09bb352>Loading ads...</p>`);
      }
      _push(`</div>`);
    };
  }
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/DynamicAds.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const DynamicAds = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-d09bb352"]]);
const _sfc_main = {
  __name: "MyLayout",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Layout2), _attrs, {
        "aside-bottom": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(DynamicAds, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(DynamicAds)
            ];
          }
        }),
        _: 1
...
async function createApp() {
  ...
  app.component("Mermaid", _sfc_main$17);
