...
import "mermaid";
const localSearchIndex = { "root": () => import("./@localSearchIndexroot.BrgSmHTe.js") };
class LRUCache {
  constructor(max = 10) {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        var _a2, _b2, _c, _d;
        _push2(`<div role="button"${ssrRenderAttr("aria-owns", ((_a2 = results.value) == null ? void 0 : _a2.length) ? "localsearch-list" : void 0)} aria-expanded="true" aria-haspopup="listbox" aria-labelledby="localsearch-label" class="VPLocalSearchBox" data-v-797a7f7c><div class="backdrop" data-v-797a7f7c></div><div class="shell" data-v-797a7f7c><form class="search-bar" data-v-797a7f7c><label${ssrRenderAttr("title", buttonText.value)} id="localsearch-label" for="localsearch-input" data-v-797a7f7c><span aria-hidden="true" class="vpi-search search-icon local-search-icon" data-v-797a7f7c></span></label><div class="search-actions before" data-v-797a7f7c><button class="back-button"${ssrRenderAttr("title", unref(translate)("modal.backButtonTitle"))} data-v-797a7f7c><span class="vpi-arrow-left local-search-icon" data-v-797a7f7c></span></button></div><input${ssrRenderAttr("value", unref(filterText))}${ssrRenderAttr("placeholder", buttonText.value)} id="localsearch-input" aria-labelledby="localsearch-label" class="search-input" data-v-797a7f7c><div class="search-actions" data-v-797a7f7c>`);
        if (!disableDetailedView.value) {
          _push2(`<button type="button" class="${ssrRenderClass([{ "detailed-list": unref(showDetailedList) }, "toggle-layout-button"])}"${ssrRenderAttr("title", unref(translate)("modal.displayDetails"))} data-v-797a7f7c><span class="vpi-layout-list local-search-icon" data-v-797a7f7c></span></button>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`<button class="clear-button" type="reset"${ssrIncludeBooleanAttr(disableReset.value) ? " disabled" : ""}${ssrRenderAttr("title", unref(translate)("modal.resetButtonTitle"))} data-v-797a7f7c><span class="vpi-delete local-search-icon" data-v-797a7f7c></span></button></div></form><ul${ssrRenderAttr("id", ((_b2 = results.value) == null ? void 0 : _b2.length) ? "localsearch-list" : void 0)}${ssrRenderAttr("role", ((_c = results.value) == null ? void 0 : _c.length) ? "listbox" : void 0)}${ssrRenderAttr("aria-labelledby", ((_d = results.value) == null ? void 0 : _d.length) ? "localsearch-label" : void 0)} class="results" data-v-797a7f7c><!--[-->`);
        ssrRenderList(results.value, (p, index) => {
          _push2(`<li role="option"${ssrRenderAttr("aria-selected", selectedIndex.value === index ? "true" : "false")} data-v-797a7f7c><a${ssrRenderAttr("href", p.id)} class="${ssrRenderClass([{
            selected: selectedIndex.value === index
          }, "result"])}"${ssrRenderAttr("aria-label", [...p.titles, p.title].join(" > "))} data-v-797a7f7c><div data-v-797a7f7c><div class="titles" data-v-797a7f7c><span class="title-icon" data-v-797a7f7c>#</span><!--[-->`);
          ssrRenderList(p.titles, (t, index2) => {
            _push2(`<span class="title" data-v-797a7f7c><span class="text" data-v-797a7f7c>${t ?? ""}</span><span class="vpi-chevron-right local-search-icon" data-v-797a7f7c></span></span>`);
          });
          _push2(`<!--]--><span class="title main" data-v-797a7f7c><span class="text" data-v-797a7f7c>${p.title ?? ""}</span></span></div>`);
          if (unref(showDetailedList)) {
            _push2(`<div class="excerpt-wrapper" data-v-797a7f7c>`);
            if (p.text) {
              _push2(`<div class="excerpt" inert data-v-797a7f7c><div class="vp-doc" data-v-797a7f7c>${p.text ?? ""}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="excerpt-gradient-bottom" data-v-797a7f7c></div><div class="excerpt-gradient-top" data-v-797a7f7c></div></div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div></a></li>`);
        ...
        if (unref(filterText) && !results.value.length && enableNoResults.value) {
          _push2(`<li class="no-results" data-v-797a7f7c>${ssrInterpolate(unref(translate)("modal.noResultsText"))} &quot;<strong data-v-797a7f7c>${ssrInterpolate(unref(filterText))}</strong>&quot; </li>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</ul><div class="search-keyboard-shortcuts" data-v-797a7f7c><span data-v-797a7f7c><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.navigateUpKeyAriaLabel"))} data-v-797a7f7c><span class="vpi-arrow-up navigate-icon" data-v-797a7f7c></span></kbd><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.navigateDownKeyAriaLabel"))} data-v-797a7f7c><span class="vpi-arrow-down navigate-icon" data-v-797a7f7c></span></kbd> ${ssrInterpolate(unref(translate)("modal.footer.navigateText"))}</span><span data-v-797a7f7c><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.selectKeyAriaLabel"))} data-v-797a7f7c><span class="vpi-corner-down-left navigate-icon" data-v-797a7f7c></span></kbd> ${ssrInterpolate(unref(translate)("modal.footer.selectText"))}</span><span data-v-797a7f7c><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.closeKeyAriaLabel"))} data-v-797a7f7c>esc</kbd> ${ssrInterpolate(unref(translate)("modal.footer.closeText"))}</span></div></div></div>`);
      }, "body", false, _parent);
    };
  }
});
...
const VPLocalSearchBox = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-797a7f7c"]]);
export {
